...
`python tests/test_youtube.py` übergibt seit der Gesamtprüfung Gruppe 7 an
pytest und lädt damit auch diese Datei (vorher ein eigener Runner ohne Wache,
der nur 59 von 213 Tests sah). Der Import der Testdatei als Skript liest die
echten Daten wie jeder Import der App (nur lesend).
